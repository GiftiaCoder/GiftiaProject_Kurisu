...
void CGLImgFrame::GLInitTexture(GLuint tex)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F_ARB, CConfig::INPUT_IMAGE_WIDTH, CConfig::INPUT_IMAGE_HEIGHT, 0, GL_BGRA_EXT, GL_FLOAT, NULL);
	//gluBuild2DMipmaps(GL_TEXTURE_2D, GL_RGB32F_ARB, CConfig::INPUT_IMAGE_WIDTH, CConfig::INPUT_IMAGE_HEIGHT, GL_BGRA_EXT, GL_FLOAT, NULL);
